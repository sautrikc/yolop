...
_C.DATASET.DATAROOT = 'D:/Honda/Internship/YOLOP/Final_Modelling/dataset_root/images'       # the path of images folder
_C.DATASET.LABELROOT = 'D:/Honda/Internship/YOLOP/Final_Modelling/dataset_root/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = 'D:/Honda/Internship/YOLOP/Final_Modelling/dataset_root/da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = 'D:/Honda/Internship/YOLOP/Final_Modelling/dataset_root/ll_seg_annotations'               # the path of ll_seg_annotations folder
